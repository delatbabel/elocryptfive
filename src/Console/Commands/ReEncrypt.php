 ...
 * * Add 'App\Console\Commands\ReEncrypt' to the $commands array in your App\Console\Kernel
 *   package.
 *
 * ### Example
 *
 * <code>
 * php artisan elocrypt:reencrypt
 * </code>
 */
class ReEncrypt extends Command
{
     ...
     * @var string
     */
    protected $signature = 'elocrypt:reencrypt';
